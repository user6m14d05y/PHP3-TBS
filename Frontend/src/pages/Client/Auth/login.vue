          ...
          <div>
            ...
            <div class="mt-1">
              <input 
                ...
                autocomplete="email"  
                v-model="email"
                class="appearance-none block w-full px-4 py-3 border border-pink-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-pink-500 transition duration-200"
